...
-- 25 standalone, re-runnable SQL queries against database/covid_tracker.db
-- Every query here was executed by etl/run_queries.py; see reports/SQL_Query_Results.md
